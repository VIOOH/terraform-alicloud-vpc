...
resource "alicloud_vswitch" "vswitches" {
  ...
  vpc_id            = var.vpc_id != "" ? var.vpc_id : alicloud_vpc.vpc[count.index].id
...
resource "alicloud_route_entry" "route_entry" {
  ...
  route_table_id        = var.route_table_id != "" ? var.route_table_id : var.vpc_id == "" ? alicloud_vpc.vpc[count.index].route_table_id : ""
